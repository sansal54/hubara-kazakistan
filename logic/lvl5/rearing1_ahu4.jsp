...
<img id="multiPartLogicImage1" src="rearing1_ahu4%40164446.png?pt=1" style="position:absolute; top:0px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage2" src="rearing1_ahu4%40164446.png?pt=2" style="position:absolute; top:1000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage3" src="rearing1_ahu4%40164446.png?pt=3" style="position:absolute; top:2000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage4" src="rearing1_ahu4%40164446.png?pt=4" style="position:absolute; top:3000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage5" src="rearing1_ahu4%40164446.png?pt=5" style="position:absolute; top:4000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage6" src="rearing1_ahu4%40164446.png?pt=6" style="position:absolute; top:5000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:1000px;" /><img id="multiPartLogicImage7" src="rearing1_ahu4%40164446.png?pt=7" style="position:absolute; top:6000px; left:0px; z-index:0; visibility:hidden; width:2065px; height:569px;" /><script>
...
return;
              ...
              {   
                 ...
                 renderArea("ma_dmp_ctrl", "1408,4905,1529,4921");
                 ...
                 renderArea("m557", "752,2881,784,2905");
                 renderArea("m558", "1272,4889,1320,4929");
                 renderArea("oat", "47,313,168,344");
                 renderArea("oah", "263,313,384,344");
                 renderArea("winter_mode", "111,3081,176,3097");
                 renderArea("m556", "224,3145,264,3165");
                 renderArea("g9_filter_status", "1063,5097,1184,5113");
                 renderArea("g9filter", "1912,5089,1992,5121");
                 renderArea("m572", "1752,5097,1800,5121");
                 ...
                 renderArea("m560", "456,1553,504,1593");
                 out.println("); </script>");
                 out.flush();
              }   
...
<% }              public void n_Ary_Method_Call_1() throws Exception, JspException, Throwable {   
                ...
                mbRenderer40("ecstpt",4625, 56);   
                mbRenderer44("ec_setpt_lock",4625, 144);   
                mbRenderer29("econ_stpt_tn",4610, 232);   
                mbRenderer45("m491",4625, 232);   
                ...
                mbRenderer49("sat_lo_lmt",5801, 376);   
                mbRenderer11("m550",5801, 720);   
                mbRenderer6("m553",5761, 600);   
                mbRenderer6("m554",5801, 600);   
                mbRenderer8("m555",5833, 840);   
                mbRenderer50("smoke_sa",6121, 191);   
                mbRenderer5("m561",6121, 376);   
                mbRenderer50("smoke_ra",6145, 191);   
                mbRenderer50("ssp_stop",6217, 191);   
                mbRenderer50("m562",5913, 31);   
                ...
                mbRenderer50("m590",6369, 335);   
                mbRenderer51("m605",6497, 327);   
                mbRenderer50("m610",6465, 191);   
                mbRenderer51("m611",6369, 615);   
                mbRenderer37("heat_status",6353, 824);   
                mbRenderer37("pheat_status",6497, 832);   
                mbRenderer50("er_pump_status",6465, 623);   
                mbRenderer51("sf_vfd_fdbk",6305, 183);   
                mbRenderer51("rf_vfd_fdbk",6401, 183);   
                mbRenderer50("m612",6497, 191);   
                mbRenderer51("hum_setpt",6337, 471);   
                mbRenderer51("dehum_setpt",6305, 615);   
                mbRenderer51("hum_limit",6369, 471);   
                mbRenderer51("m680",6433, 471);   
                mbRenderer51("co2_stpt",6497, 39);   
                mbRenderer50("zco2_hi",6465, 47);   
              }    
              public void n_Ary_Method_Call_2() throws Exception, JspException, Throwable {   
                ...
                mbRenderer52("m001",1001, 671);   
                mbRenderer52("m543",1649, 711);   
                ...
                mbRenderer53("hw_ht_stpt",2513, 96);   
                mbRenderer43("m633",2297, 71);   
                mbRenderer1("cln_time",2281, 632);   
                mbRenderer39("cln_per",2281, 520);   
                mbRenderer54("m634",2281, 408);   
                mbRenderer1("m635",2313, 632);   
                mbRenderer43("m639",2209, 71);   
                mbRenderer49("hw_frost_en",2161, 168);   
                mbRenderer49("hw_frost_en2",2185, 168);   
                mbRenderer45("m640",2449, 200);   
                ...
                mbRenderer51("m530",4889, 871);   
                mbRenderer18("ma_dmp_ctrl",4905, 1408);   
                ...
                mbRenderer53("cdsp_high",3689, 264);   
                ...
                mbRenderer56("m463",3457, 784);   
                mbRenderer51("total_clstages",3473, 687);   
                ...
                mbRenderer8("m557",2881, 752);   
                mbRenderer25("m558",4889, 1272);   
                mbRenderer57("oat",313, 47);   
                mbRenderer57("oah",313, 263);   
                mbRenderer2("winter_mode",3081, 111);   
                mbRenderer7("m556",3145, 224);   
                mbRenderer12("g9_filter_status",5097, 1063);   
                mbRenderer10("g9filter",5089, 1912);   
                mbRenderer11("m572",5097, 1752);   
                mbRenderer3("g9_filter_tn",5123, 1872);   
                mbRenderer23("htv_min",4257, 479);   
                mbRenderer26("bldg_press_m2",1529, 392);   
                mbRenderer22("m560",1553, 456);   
              }    
