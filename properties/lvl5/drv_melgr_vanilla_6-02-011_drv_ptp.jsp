...
<table border="0" cellpadding="0" cellspacing="6">
 ...
 <jsp:include page="drv_melgr_vanilla_6-02-011_drv_ptp_dialup1.jsp" flush="true" />
 <jsp:include page="drv_melgr_vanilla_6-02-011_drv_ptp_dialup2.jsp" flush="true" />
 <jsp:include page="drv_melgr_vanilla_6-02-011_drv_ptp_dialup3.jsp" flush="true" />
 <jsp:include page="drv_melgr_vanilla_6-02-011_drv_ptp_dialup4.jsp" flush="true" />
 <jsp:include page="drv_melgr_vanilla_6-02-011_drv_ptp_dialup5.jsp" flush="true" />
 </table></td></tr>
</table>
</tr>
